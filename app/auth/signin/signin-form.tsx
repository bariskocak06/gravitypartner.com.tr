    ...
    <div className="w-full max-w-sm space-y-6">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-[#050509] px-2 text-muted-foreground font-mono">veya</span>
        </div>
      </div>

      <Link
        href="/api/auth/signin/google"
        className="flex w-full items-center justify-center gap-2 rounded-lg border border-border bg-white/5 py-2.5 font-medium text-foreground hover:bg-white/10 transition"
      >
